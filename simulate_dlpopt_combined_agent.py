...
def simulation(
    ...
    agent_combined = CombinedAgent(action_space=env.action_space, **params["combined"])

    agent_returns = DeepLPortfolioAgent(
        action_space=env.action_space, **params["dlpopt_returns"]
    )

    agent_volatility = DeepLPortfolioAgent(
        action_space=env.action_space, **params["dlpopt_volatility"]
    )

    agent_returns._id = "dlpopt_returns"

    agent_volatility._id = "dlpopt_volatility"
